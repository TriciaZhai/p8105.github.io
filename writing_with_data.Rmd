...
Below is a first RMD file. To follow along, <a href "https://raw.githubusercontent.com/p8105/p8105.github.io/master/resources/template.Rmd" download>download the file</a> and save it somewhere that makes sense. Alternatively, create a .Rmd file using File > New File > R Markdown, and replace the default text with what's below. 
