...
<script async class="speakerdeck-embed" data-id="f1ca5d878d3f429692f3350bd4ef8f77" data-ratio="1.33333333333333" src="//speakerdeck.com/assets/embed.js"></script>
...
Below is a first RMD file. To follow along, [download the file](resources/template.Rmd) and save it somewhere that makes sense. Alternatively, create a .Rmd file using File > New File > R Markdown, and replace the default text with what's below. 
...
[Here](resources/rmd_vec_classes.Rmd) is a R Markdown file for vector classes, and [here](resources/rmd_basic_plots.Rmd)'s one for basic plots.
