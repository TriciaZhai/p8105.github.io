...
Below is a first RMD file. To follow along, <a href="resources/template.Rmd" download>download the file</a> and save it somewhere that makes sense. Alternatively, create a .Rmd file using File > New File > R Markdown, and replace the default text with what's below. 
