...
<script async class="speakerdeck-embed" data-id="3b324ada29974681999fe129bb08a3ce" data-ratio="1.33333333333333" src="//speakerdeck.com/assets/embed.js"></script>
...
For this example, I'll a new R Markdown file to the repo / project I started for the [Data Wrangling I](topic_data_wrangling_i.html) topic; this will make it easy to load example data sets using the code I wrote in [data import](data_import.html).
