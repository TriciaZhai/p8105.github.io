...
```{r eval = FALSE}
install.packages(c("tidyverse", "knitr", "janitor", "broom", "here", "shiny", "readxl", "haven", "rnoaa", "ggridges", "viridis", "skimr", "rvest", "httr", "flexdashboard", "devtools", "rmarkdown", "modelr"))
```
