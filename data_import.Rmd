...
<script async class="speakerdeck-embed" data-id="d59e5ea4d1674e6785ec9aea6620b7b2" data-ratio="1.33333333333333" src="//speakerdeck.com/assets/embed.js"></script>
...
Relative paths, meanwhile, start from your current working directory. Relative paths are portable, in that someone else with the same directory will have the same **relative** path to files in the directory. For both of these reasons, relative paths are preferred in almost every setting. The code below finds my current working directory:
