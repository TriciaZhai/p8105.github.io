...
We'll continue in the same Git repo / R project that we used for visualization, and use essentially the same dataset -- the only exception is the addition of `month` variable, created using `lubridate::floor_date()`. 
